...
public final class Problem extends RuntimeException
{
    static public enum Constants
    {
        ...
        INVALID_ENUMERATION_CONSTANT(0x415),
        TYPES_MUST_NOT_NEST(0x416),
        ...
        UNSUPPORTED_ENUMERATION_TYPE(0x458),
        ...
        CANNOT_ACCESS_THIS_BEFORE_SUPER(0x474),
        UNALLOWED_PATTERN_ON_UNION_CLASS(0x475),
        UNALLOWED_UNION_WITH_SUPER_OPERATOR(0x476),
        UNALLOWED_ACCESS_WITH_SUPER_OPERATOR(0x477),
        PROCESSING_TYPE_ANNOTATION(0x478),
        EXPECTING_NUMERIC_DATA_TYPE(0x479),
        REDEFINING_SUPER_CLASS_PROPERTY(0x47a),
        RESERVED_123(0x47b),
        RESERVED_124(0x47c),
        RESERVED_125(0x47d);
    ...
    static public class Emitter
    {
        static private String[] _problems = new String[]
        {
            ...
            "Enumeration constant contains unallowed elements.",
            "Types must not be nested.",
            ...
            "Enumeration %1$s has no constant %2$s.",
        ...
        public String emitProblem(Problem p)
        {
            ...
            return emitForm(p.errorId(), VectorUtils.toArray(stringBuilder));
        }
        ...
        public String emitArgument(Problem.Argument argument)
        {
            ...
            if (argument.isSymbolArgument())
            {
                ...
                else if (symbol.accessingProperty() != null)
                {
                    return symbol.accessingProperty().name().toString();
                }
                else
                {
